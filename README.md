...
在 VS Code 里直接阅读[番茄小说](https://fanqienovel.com/)：抖音扫码登录、书城（排行榜/分类）、搜索、书架、阅读历史、阅读器（上下翻页/字号主题）、章评/段评。
...
- **阅读历史**自动记录最近读过的书（无需登录即可记录）；**登录后自动合并云端阅读进度**，换设备也能看到历史，在「个人信息」页可查看、点击续读、清空本地记录。

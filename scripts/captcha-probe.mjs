// Find how the site handles 1105 slide captcha (TTGCaptcha usage + result submission).
...
function ctx(key, from = 0, len = 800, max = 3) {
  const found = [];
...
ctx('TTGCaptcha', 0, 500, 3);
ctx('verify_center_decision_conf', 0, 500, 3);
ctx('1105', 0, 400, 3);
ctx('tt_send_sms_login', 0, 400, 2);
ctx('verify_ticket', 0, 350, 3);
ctx('captcha/verify', 0, 400, 3);
